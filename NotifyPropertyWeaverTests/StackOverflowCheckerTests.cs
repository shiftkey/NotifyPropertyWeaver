...
public class StackOverflowCheckerTests
{
    ...
    public void SetUp()
    {
        stackOverflowChecker = new StackOverflowChecker(null, null, new TypeResolver());
    }
    ...
    {
        new WeaverHelper(@"AssemblyWithStackOverflow\AssemblyWithStackOverflow.csproj", true);
    }
