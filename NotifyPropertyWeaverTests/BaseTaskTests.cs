...
public abstract class BaseTaskTests
{
    ...
    public void VirtualForNonSealed()
    {
        ...
        var methodInfo = type.GetMethod("CustomEventInvoker");
    ...
    [Test]
    public void WithBranchingReturn2()
    {
    ...
    [Test]
    public void ClassWithBranchingReturnAndNoField()
    {
    ...
    [Test]
    public void ClassWithFieldGetButNoFieldSet()
    {
    ...
    [Test]
    public void WithCustomEventInvoker()
    {
        var instance = assembly.GetInstance("ClassWithCustomEventInvoker");
        EventTester.TestProperty(instance, false);
    }
    
    [Test]
    public void WithGenericAmdLambda()
    {
   ...
   public void GenericBaseWithPropertyOnChanged()
   {
    ...
    [Test]
    public void WithIsChangedFalse()
    {
		var instance = assembly.GetInstance("ClassWithIsChangedFalse");
        Assert.IsFalse(instance.IsChanged);
        EventTester.TestProperty(instance, false);
        Assert.IsFalse(instance.IsChanged);
    }
    ...
    [Test]
    public void DontCheckForEquality()
    {
        var type = assembly.GetType("ClassDontCheckForEquality", true);
        dynamic instance = Activator.CreateInstance(type);
        var property1EventCalled = false;
        instance.PropertyChanged += new PropertyChangedEventHandler((sender, args) =>
                                                                        {
